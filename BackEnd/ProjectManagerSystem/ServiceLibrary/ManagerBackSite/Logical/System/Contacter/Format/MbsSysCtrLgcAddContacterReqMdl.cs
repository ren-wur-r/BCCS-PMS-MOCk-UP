...
/// <summary>管理者後台-客戶名單-客戶窗口-邏輯-新增窗口-請求模型</summary>
public class MbsSysCtrLgcAddContacterReqMdl : MbsLgcBaseReqMdl
{
    ...
    public List<MbsSysCtrLgcAddContacterReqRatingItemMdl> ManagerContacterRatingList { get; set; }
}
