...
/// <summary>管理者後台-系統設定-員工-更新-請求模型</summary>
public class MbsSysEmpLgcUpdateReqMdl : MbsLgcBaseReqMdl
{
    ...
    public List<MbsSysEmpLgcUpdateItemReqMdl> EmployeePermissionList { get; set; }
