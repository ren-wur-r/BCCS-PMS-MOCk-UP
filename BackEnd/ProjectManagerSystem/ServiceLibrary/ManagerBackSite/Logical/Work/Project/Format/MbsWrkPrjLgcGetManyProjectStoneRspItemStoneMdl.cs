...
/// <summary>管理後台-工作-專案-服務-取得多筆專案里程碑-回應項目里程碑模型</summary>
public class MbsWrkPrjLgcGetManyProjectStoneRspItemStoneMdl
{
    ...
    public List<MbsWrkPrjLgcGetManyProjectStoneRspItemTaskMdl> EmployeeProjectStoneJobList { get; set; }
}