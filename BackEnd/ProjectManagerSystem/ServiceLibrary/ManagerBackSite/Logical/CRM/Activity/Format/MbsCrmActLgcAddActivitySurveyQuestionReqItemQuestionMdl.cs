...
/// <summary>管理者後台-CRM-活動管理-新增活動問卷問題-問題項目請求模型</summary>
public class MbsCrmActLgcAddActivitySurveyQuestionReqItemQuestionMdl  // 移除繼承
{
    /// <summary>管理者活動問卷問題-活動ID</summary>
    ...
    public List<MbsCrmActLgcAddActivitySurveyQuestionReqItemQuestionItemMdl> ManagerActivitySurveyQuestionItemList { get; set; }
