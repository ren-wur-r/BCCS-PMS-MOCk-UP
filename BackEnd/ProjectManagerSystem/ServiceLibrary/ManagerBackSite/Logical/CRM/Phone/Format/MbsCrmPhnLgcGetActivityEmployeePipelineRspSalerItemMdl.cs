...
/// <summary>管理者後台-CRM-電銷管理-邏輯服務-取得活動名單-指派業務項目-回應模型</summary>
public class MbsCrmPhnLgcGetActivityEmployeePipelineRspSalerItemMdl
{
