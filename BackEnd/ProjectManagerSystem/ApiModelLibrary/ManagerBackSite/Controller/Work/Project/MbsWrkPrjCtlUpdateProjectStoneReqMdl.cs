...
/// <summary>管理後台-工作-專案-控制器-更新專案里程碑-請求模型</summary>
public class MbsWrkPrjCtlUpdateProjectStoneReqMdl : MbsCtlBaseReqMdl
{
    ...
    [JsonPropertyName("f")]
    public List<MbsWrkPrjCtlUpdateProjectStoneReqItemJobMdl> EmployeeProjectStoneJobList { get; set; }
}